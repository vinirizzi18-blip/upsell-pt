      ...
      <main className="max-w-6xl mx-auto px-4 mt-12 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-[2.5rem] overflow-hidden shadow-2xl">
            <img src="https://images.unsplash.com/photo-1494390248081-4e521a5940db?q=80&w=1000&auto=format&fit=crop" alt="Mulher" className="w-full h-auto block" />
          </div>
          <div className="rounded-[2.5rem] overflow-hidden shadow-2xl">
            <img src="https://images.unsplash.com/photo-1506784365847-bbad939e9335?q=80&w=1000&auto=format&fit=crop" alt="Calendário" className="w-full h-auto block" />
          </div>
        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto text-left space-y-8 text-slate-700 leading-relaxed">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-6">
            <p className="text-lg">
              Ter 250 receitas é o primeiro passo. Mas sem um plano de execução, o teu congelador vai continuar vazio e a tua cozinha vai continuar um caos.
            </p>
            <p className="text-lg">
              Cozinhar para congelar exige estratégia. Se tentares fazer todas as receitas ao mesmo tempo, vais passar o fim de semana inteiro na cozinha.
            </p>
            {/* CAIXA DE CITAÇÃO (ESTAVA A FALTAR) */}
            <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-green-500">
            ...
            <p className="text-lg">
              Para resolver isto, criei o <span className="text-green-600 font-bold">Guia de Organização Pro</span>. É o complemento ideal para as tuas 250 receitas:
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="grid gap-4">
              {[
                ...
                { title: "Contagem de Calorias e Macros", desc: "O cálculo detalhado de cada refeição que não está incluído no teu ebook." },
          ...
          {/* CAIXA VERDE DE DESTAQUE (ESTAVA A FALTAR) */}
          <div className="bg-green-50 p-8 rounded-3xl border-2 border-dashed border-green-200 mt-12">
            <h3 className="text-xl font-bold text-green-800 mb-4 flex items-center gap-2">
              📍 Guia de Organização Pro
            </h3>
            <p className="text-slate-700 leading-relaxed">
              Não percas mais tempo a decidir o que cozinhar ou a fazer contas de calorias. Com o <span className="font-bold text-green-700">Guia de Organização Pro</span>, recebes o plano de execução para as tuas 250 receitas, com listas de compras inteligentes e a contagem de macros detalhada de cada prato.
            </p>
          </div>
        </div>
        ...
        <div className="mt-20 max-w-md mx-auto">
          <img src="https://iili.io/qFCDIEb.png" alt="Resultados" className="w-full h-auto rounded-[2.5rem] shadow-2xl" />
        </div>
        ...
        <div className="mt-20 max-w-4xl mx-auto px-4 text-center">
          <div className="bg-[#fff5f5] border border-[#ff4d4d] rounded-2xl p-10 md:p-14 shadow-lg">
            ...
            <p className="text-lg md:text-2xl text-slate-700 leading-relaxed mb-8">
              ...
              <span className="font-bold text-slate-900 uppercase">Guia de Organização Pro</span> por apenas <span className="text-[#22c55e] font-black">17€</span>.
            </p>
